					...
					<div class="col-lg-3 col-md-6 col-sm-12 mb-30">
						<div class="da-card box-shadow">
							<div class="da-card-photo">
								<img src="vendors/images/photo.jpg" alt="">
							...
							<div class="da-card-content">
								...
								include"koneksi.php";
								$total = mysqli_query($koneksi,"SELECT jumlah FROM tbl_vote where id_paslon=2");

								$data = mysqli_num_rows($total);
								?>
								<p> Total suara : <?php echo $data;?>
					...
					<div class="col-lg-3 col-md-6 col-sm-12 mb-30">
						<div class="da-card box-shadow">
							...
							<div class="da-card-content">
								...
								include"koneksi.php";
								$total = mysqli_query($koneksi,"SELECT jumlah FROM tbl_vote where id_paslon=1");
